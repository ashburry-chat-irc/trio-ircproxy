...
user_file_str: str = os.path.join('../trio_ircproxy', 'scripts', 'website_and_proxy', 'users.dat')
user_file = Path(user_file_str)

sysdir_path: str = os.path.join(appdirs.user_config_path(), "trio_ircproxy-5ioE.3")
xdccdir_path: str = os.path.join(appdirs.user_config_path(), "trio_ircproxy-5ioE.3", "xdcc_search")
